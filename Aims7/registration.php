                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="col-md-3 col-xs-3">
                                    ...
                                    <div class="logonext float-left">
                                        <a class="navbar-brand" href="index.html"><img src="img/favicon.png" alt=""></a>
                                    </div>
                                    <button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#main-menu-2" style="float: left; margin: 0;">
                                ...
                                <div class="col-md-9 col-xs-9">
                                    ...
                                    <div class="main-menu float-right collapse navbar-collapse" id="main-menu-2">
                                        <nav> 
                                            <ul>
                                                <li><a>About<span class="dropdown fa fa-angle-down" style="padding-left: 5px;"></span></a></a>
                                                    <ul>
                                                      <li><a href="faq.html"><i class="fa fa-chevron-right"></i>FAQ's</a></li>
                                                      <li><a href="product.html"><i class="fa fa-chevron-right"></i>Portfolio</a></li>
                                                    </ul>
                                                </li>
                                                <li><a>Softwares<span class="dropdown fa fa-angle-down" style="padding-left: 5px;"></span></a></a>
                                                    <ul>
                                                      <li><a href="version.html"><i class="fa fa-chevron-right"></i>Version</a></li>
                                                      <li><a href="versiondetails.html"><i class="fa fa-chevron-right"></i>Version Details</a></li>
                                                      <li><a href="download.html"><i class="fa fa-chevron-right"></i>download</a></li>
                                                    </ul>
                                                </li>

                                                <li><a>Apps<span class="dropdown fa fa-angle-down" style="padding-left: 5px;"></span></a></a>
                                                    <ul>
                                                      <li><a href="version.html"><i class="fa fa-chevron-right"></i>Version</a></li>
                                                      <li><a href="versiondetails.html"><i class="fa fa-chevron-right"></i>Version Details</a></li>
                                                    </ul>
                                                ...
                                                <li><a>Support<span class="dropdown fa fa-angle-down" style="padding-left: 5px;"></span></a></a>
                                                    <ul>
                                                      <li><a href="versiondetails.html"><i class="fa fa-chevron-right"></i>Documentation</a></li>
                                                      
                                                      <li><a href="versiondetails.html"><i class="fa fa-chevron-right"></i>Video Tutorials</a></li>

                                                      <li><a href="faq.html"><i class="fa fa-chevron-right"></i>FAQ's</a></li>

                                                      <li><a href="#ve"><i class="fa fa-chevron-right"></i>Support Forum</a></li>
                                                ...
                                                <li><a>Login<span class="dropdown fa fa-angle-down" style="padding-left: 5px;"></span></a></a>
                                                    <ul>
                                                      <li><a href="version.html"><i class="fa fa-chevron-right"></i>Admin Login</a></li>
                                                      <li><a href="versiondetails.html"><i class="fa fa-chevron-right"></i>AIMS7 Login</a></li>
                                                    </ul>
                                                </li>
       		...
       		<section class="contactbody">
	            <div class="container"> 
	              	<div class="row">
	              		...
	              		<div class="col-md-6 col-sm-6 col-xs-6 contactfrom">
	              		    <?php if($msg!='') echo $msg; ?>
	              		    <?php if($err!='') echo $err; ?>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="footercontent">
                            ...
                            <h1><i class="fa fa-copyright"></i><p>2019 aims7.com</p></h1>
                        </div>
                    </div>
